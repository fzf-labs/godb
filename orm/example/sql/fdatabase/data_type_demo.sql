...
COMMENT ON TABLE public.data_type_demo IS '数据类型';
...
COMMENT ON COLUMN public.data_type_demo.data_type_date IS '数据类型 date';
COMMENT ON COLUMN public.data_type_demo.data_type_float4 IS '数据类型 float4';
COMMENT ON COLUMN public.data_type_demo.data_type_float8 IS '数据类型 float8';
COMMENT ON COLUMN public.data_type_demo.data_type_timestamp IS '数据类型 timestamp';
COMMENT ON COLUMN public.data_type_demo.data_type_bytea IS '数据类型 bytea';
COMMENT ON COLUMN public.data_type_demo.data_type_numeric IS '数据类型 numeric';
COMMENT ON COLUMN public.data_type_demo.data_type_interval IS '数据类型 interval';
...
CREATE INDEX data_type_demo_data_type_bool_idx ON public.data_type_demo USING btree (data_type_bool);
